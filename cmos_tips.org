...
ibus, ibus-sunpinyin
** python
beautifulsoup4, diff-match-patch, Django, djangorestframework, httpie, django-bootstrap3, django-ckeditor, django-registration-redux, django-reversion, ipython, jupyter, Jinja2, matplotlib, networkx, nltk, numpy, openpyxl, cython, pandas, Pillow, pip, psycopg2, mysqlclient, pytz, pyverilog, scikit-learn, scipy, setuptools, sympy, wheel, xlrd, xlutils, xlwt, sphinx, jieba, SQLAlchemy, XlsxWriter, astropy, texttable, nested-dict, gitpython, line_profiler, memory_profiler, pycurl
** emacs
